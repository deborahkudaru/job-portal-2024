...
const Brands = () => {
  return (
    <div className="flex lg:gap-20 justify-between relative lg:bottom-14 bg-sky-100 lg:px-48 px-10">
      <img src={airtable} alt="airtable-logo" className="lg:w-32 w-16" />
      <img src={amplitude} alt="amplitude-logo" className="lg:w-32 w-16" />
      <img src={rippling} alt="rippling-logo" className="lg:w-32 w-16" />
      <img src={atlassian} alt="atlassian-logo" className="lg:w-32 w-16" />
      <img src={gumroad} alt="gumroad-logo" className="lg:w-32 w-16" />
